...
(use-package agda2
  ...
  (let ((base03    "#002b36")
    ...
    (custom-set-faces
     ...
     `(agda2-highlight-unsolved-meta-face ((t (:background ,yellow :foreground ,base03))))
     `(agda2-highlight-unsolved-constraint-face ((t (:background ,yellow :foreground ,base03))))
